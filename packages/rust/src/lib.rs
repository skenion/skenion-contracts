...
pub use v0_2::{
    ...
    ValidationErrorV02, ValidationReportV02, analyze_graph_document_v02, derive_patch_contract_v02,
    derive_patch_contracts_v02, validate_graph_document_v02, validate_node_definition_v02,
